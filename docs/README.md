...
| [`operations.md`](operations.md)                         | Runbook: деплой і DB-міграції (dev vs production Neon-гілки, рецепт міграції прод)          | Перед будь-яким деплоєм або міграцією на production                                    |
