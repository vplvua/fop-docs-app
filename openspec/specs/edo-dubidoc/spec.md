...
DubiDoc EDO integration — automatic act sending via POST /api/v1/documents, polling-based status sync (signed/refused, plus removed-document detection for deleted/cancelled documents), retry with idempotency guard, re-send of removed acts, UI controls for manual send/retry/status-refresh. Covers FR-EDO-01..12, TC-INTEG-02, TC-INTEG-13, NFR-PERF-04..06.
